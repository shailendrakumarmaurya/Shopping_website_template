...
<body>
    ...
    <section class="images-priview" id="category">
        <div class="container">
            <div class="row">
                <h2 class="module align-center text-uppercase wt-100">Category</h2>
            </div>
            <?php
            ...
            ?>
                    <div class="col-12 col-md-6 col-lg-4 pt-25 float-left module">
                        <div class="preview-img">
                            <a href="<?php echo 'sub_category.php?category_id=' . $id; ?>"><img src="<?php echo $images; ?>" style="height: 200px;" /><label style="opacity: 0.8; background-color: white; font-weight: bold; display: block; overflow: hidden; white-space: nowrap; text-overflow: ellipsis; text-align: center;"><?php echo $category; ?></label></a>
                        </div>
                    </div>
            <?php
                }
